...
namespace AT_CadastroDeAniversario
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<BancoDeDados>(options => 
                                    options.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=BancoDeDados;Trusted_Connection=True;MultipleActiveResultSets=true"));
